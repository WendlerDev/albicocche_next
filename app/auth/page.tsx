        ...
        `}>
            ...
            `}>
                ...
                `} />
                    ...
                    ml-3
                    items-center`}>
                            <Logo src="/google.svg" alt="Logo Google" width={20} height={20} priority />
                            <span className={`ml-2 justify-center items-center`}>Login with Google</span>
                        </div>
                    </button>
                    {authType === 'login' ? (
                        <p className={`
